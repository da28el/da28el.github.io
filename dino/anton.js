...
const dino_w = 31;//32;
const dino_h = 49;//64;
const dino_run1 = new Image(31, 49);//new Image(16, 32);
dino_run1.src = "https://da28el.github.io/dino/anton.png";//"plant1.png";
const dino_run2 = new Image(31, 49)//new Image(16, 32)
dino_run2.src = "https://da28el.github.io/dino/anton2.png";//"plant2.png";
let dino_anim = 0;
let dino_theta = 0;
// physics
...
/* obstacles */
const obstacle_w = 39;//32;
const obstacle_h = 39;//64;
const obstacle_img = new Image(39,39);//new Image(16, 32);
obstacle_img.src = "https://da28el.github.io/dino/gbg.png";//"obstacle.png";
let obstacles_x = [];
let obstacles_y = [];
...
const point_w = 24;//16;
const point_h = 58;//16;
const point_img = new Image(24,58);//new Image(16, 16);
point_img.src = "https://da28el.github.io/dino/pripps.png";//"water.png";
let points_x = [];
let points_y = [];
