...
function triggerExplosion(fluid, centerX, centerY, explosionDensity, explosionForce) {
    ...
    const radius = Math.floor(N * 0.1); // Explosion affects 10% of the grid
...
triggerExplosion(fluid, 0, 0, 500, 100);
...
function get_color(d){
    let t = d >= 100.0 ? 1.0 : d <= 0.0 ? 0.0 : d;
    return `hsl(${255-t*255}, 100%, 50%)`;
